...
import { resetAdminPassword } from '@/lib/api/apiClient';
          ...
          <div className="w-full max-w-[420px]">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-[#616f89] dark:text-gray-400">
                El enlace es de un solo uso y vence en 1 hora.
              </p>
            </div>
              ...
              <form onSubmit={(ev) => void handleSubmit(ev)} className="flex flex-col gap-5 p-6 md:p-8">
                {!token ? (
                  <p className="rounded-md border border-red-500/40 bg-red-50 px-3 py-2 text-sm font-medium text-red-700 dark:bg-red-950/40 dark:text-red-400">
                    Falta el token de recuperación. Volvé a pedir un enlace.
                  </p>
                ) : null}
                {message ? (
                ...
                <div>
                  <label htmlFor="admin-new-password" className="mb-1.5 block text-sm font-semibold text-[#111318] dark:text-white">
                    Nueva contraseña
                  </label>
                  <input
                ...
                <div>
                  <label htmlFor="admin-confirm-password" className="mb-1.5 block text-sm font-semibold text-[#111318] dark:text-white">
